...
const connectToDb = (cb) =>{
    mongoose.connect("mongodb+srv://nikhilchawla9013:1icVCiLKJGHdvfSw@cluster0.of1mhqj.mongodb.net/ecommerce-app").then((_)=>{
        console.log("connected to db");
        cb();
    }).catch((_)=>{
        console.log(_, " Error in mongo db connection");
    })
}
